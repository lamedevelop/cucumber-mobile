...
class _State extends State<Main> {
  ...
  Future<String> parasha() async {
    Uri url = Uri.parse('http://127.0.0.1:8000/image/get');
    final response = await http.get(url).timeout(Duration(seconds: 5));
    return jsonDecode(utf8.decode(response.bodyBytes))['key']; 
  }
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
        ...
        home: Scaffold(
          body: Center(child: Image.memory(base64Decode(widget.lol))),
        ));
  }
}
